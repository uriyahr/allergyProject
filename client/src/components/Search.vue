<template>
  <div class="search">
    ...
    <FilterResultsTab
      :selectedFilter="selectedRestrictions"
  ...
  data: () => ({
    ...
    navBarFilters: [
      ...
      },
      {
        ...
        filterType: "checkbox",
        filters: [
          { title: "Milk", checked: false, attr: "contains_milk" },
          { title: "Egg", checked: false, attr: "contains_egg" },
          { title: "Tree Nut", checked: false, attr: "contains_treenut" },
          { title: "Peanut", checked: false, attr: "contains_peanut" },
          { title: "Shellfish", checked: false, attr: "contains_shellfish" },
          { title: "Wheat", checked: false, attr: "contains_wheat" },
          { title: "Soy", checked: false, attr: "contains_soy" },
          { title: "Fish", checked: false, attr: "contains_fish" },
          { title: "Meat", checked: false, attr: "contains_meat" },
          { title: "Animal Byproduct", checked: false, attr: "contains_altMeat" }
        ]
      }
    ]
  }),
