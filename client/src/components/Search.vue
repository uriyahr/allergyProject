  ...
  <div class="search">
    <v-app>
      ...
      <v-navigation-drawer  width="250">
        <v-list>
          <v-list-item>Filter Items</v-list-item>
          <v-divider></v-divider>
          <v-list-item v-for="(filter, i) in navBarFilters" :key="i">
            <v-list-item-content>
              ...
              <v-list-item-subtitle v-if="filter.filterType == 'checkbox'">
                <v-checkbox  v-for="(filter, i) in navBarFilters[1].filters" :key="i" :label="filter.title"> </v-checkbox>
              </v-list-item-subtitle>
              <!-- Dietary Preference -->
              <v-list-item-subtitle v-else >
                <v-radio v-for="(filter, i) in navBarFilters[0].filters" :key="i" :label="filter.title"> </v-radio>
              </v-list-item-subtitle>
